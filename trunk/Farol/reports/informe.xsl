...
<head>
<title>Farol Tool - Clasificador de Clases para la Orden de Integración</title>
</head>
...
<div align="center">
  ...
  <table border="0" cellpadding="0" cellspacing="8" width="100%">
    ...
    <tr>
      ...
      <p align="center"><span lang="pt"><font size="6" color="#0000FF">Clasificación de las Clases de
      Ensayo de la Integración</font></span></p>
      <p align="center"><i><font size="2">Generado por Farol Tool</font></i></p></td>
    ...
    <tr>
      ...
      <p align="right"><span lang="pt"><font size="2"><b><i>Creado en: 
			<xsl:for-each select="IntegrationTest/Model">
				<xsl:value-of select="@date"/><br/>
			</xsl:for-each>
</i></b></font></span></p>
      <p align="center"><u><i><b><span lang="pt"><font size="5">Descripción de las Clases</font></span></b></i></u></p>
      ...
      <table border="2" cellpadding="0" cellspacing="0" style="border-collapse: collapse" bordercolor="#111111" width="100%" id="AutoNumber2">
        <tr>
          ...
          <font size="4" color="#0000FF">Nombre</font></span></b></td>
          <td width="16%" align="center" bgcolor="#C0C0C0"><b><span lang="pt">
          <font size="4" color="#0000FF">Tamaño</font></span></b></td>
          <td width="28%" align="center" bgcolor="#C0C0C0"><b><span lang="pt">
          <font size="4" color="#0000FF">Factor de Influencia</font></span></b></td>
        </tr>        <tr>
      ...
      <p align="center"><u><i><b><span lang="pt"><font size="5">Orden de Integración</font></span></b></i></u></p>
      <div align="center">
        <center>
	...
	<xsl:for-each select="IntegrationTest/Result/Order/Class">
		...
		<xsl:value-of select="@stubs"/>
            ...
            <b><font size="4" color="#0000FF">Orden modificado</font></b></td>
                  </tr>
                  <tr>
            ...
            <font color="#000000"><b>
				...
				<xsl:for-each select="IntegrationTest/Result/Final">
                  ...
                  <tr>
            <td width="200%" style="color: navy; border-style: solid; border-width: 1; background-color: #C0C0C0" height="17" align="center" colspan="2">
            <font size="4" color="#0000FF"><b>Orden original</b></font></td>
                  </tr>
                  <tr>
            <td width="71%" style="color: navy; border-style: solid; border-width: 1; background-color: #E2E2E2" height="17" align="justify">
            ...
            <font color="#000000"><b>
                ...
                <font size="2">Grupo de Ingeniería de Software Experimental - 
