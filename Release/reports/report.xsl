		...
		<xsl:value-of select="@stubs"/>
            ...
            <font color="#000000"><b>
				...
				<table id="toolbar" align="center" cellspacing='5' cellpadding="4" >
					<tr>
					<th align="center"> <a class="toolbar" href="javascript:window.print();"><img border='0' src='printer.png' width='32' height='32'/><br/>Print</a>
					</th>
					<th align="center"><a class="toolbar" href="javascript:window.close();"><img border='0' src='cancel_f2.png' width='32' height='32'/><br/>Cancel</a>
					</th>
					</tr>
				</table>
