...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->label3->Location = System::Drawing::Point(101, 18);
			this->label3->Name = L"label3";
			this->label3->Size = System::Drawing::Size(180, 13);
			this->label3->TabIndex = 1;
			this->label3->Text = L"de in Object-oriented Software";
			...
			this->label2->Font = (gcnew System::Drawing::Font(L"Microsoft Sans Serif", 8.25F, System::Drawing::FontStyle::Bold, System::Drawing::GraphicsUnit::Point, 
				static_cast<System::Byte>(0)));
			this->label2->Location = System::Drawing::Point(19, 2);
			this->label2->Name = L"label2";
			this->label2->Size = System::Drawing::Size(347, 13);
			...
			this->label10->Text = L"Rio de Janeiro - Brazil / 2004";
